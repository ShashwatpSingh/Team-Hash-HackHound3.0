...
const SendETHToMultipleWalletsForm: React.FC<{ onClose: () => void; onSubmit: (data: any) => void }> = ({
  onClose,
  onSubmit,
}) => {
  ...
  return (
    <BaseForm title="Send ETH to Multiple Wallets" onSubmit={handleFormSubmit} onClose={onClose}>
      <div className="space-y-4">
        <div>
          <Label htmlFor="amount">Amount</Label>
          <Input id="amount" name="amount" type="string" placeholder="Enter amount" required />
        </div>
        <div>
